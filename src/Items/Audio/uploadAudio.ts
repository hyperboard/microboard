...
import { calculateAudioPosition, prepareAudio } from 'Items/Audio/AudioHelpers';
...
export function uploadAudio(
	...
	const audio = new AudioItem(board, true, undefined, board.events, '', extension);
	const { scaleX, scaleY, translateX, translateY } = calculateAudioPosition(board, audio);
