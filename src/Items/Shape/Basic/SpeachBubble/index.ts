...
export const createSpeachBubblePath = (mbr: Mbr) => {
	...
	if (ratio >= 1) {
		...
		return new Path(
			[
				...
				new Line(new Point(100, farBreakpoint), new Point(100, 90 - farBreakpoint)),
				new CubicBezier(
					new Point(100, 90 - farBreakpoint),
					new Point(100, 90 - nearBreakpoint - convexity),
					new Point(100 - quotientFarBreakpoint, 90),
					new Point(100 - quotientNearBreakpoint + quotientConvexity, 90)
				),
				new Line(new Point(100 - quotientFarBreakpoint, 90), new Point(30, 90)),
				new Line(new Point(30, 90), new Point(20, 100)),
				new Line(new Point(20, 100), new Point(20, 90)),
				new Line(new Point(20, 90), new Point(quotientFarBreakpoint, 90)),
				new CubicBezier(
				...
				new Line(new Point(0, 90 - farBreakpoint), new Point(0, farBreakpoint)),
			],
			true
		);
	}
	...
	return new Path(
		[
			...
			new Line(new Point(0, 90 - quotientFarBreakpoint), new Point(0, quotientFarBreakpoint)),
		],
		true
	);
};
